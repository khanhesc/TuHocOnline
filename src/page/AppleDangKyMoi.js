...
class AppleDangKyMoi extends Component {
  ...
  onTGNiemMotChuChange(value) {
    var user = this.state.user;
    user.tgNiemMatChu = value;
    this.setState({user: user, errorTGNiemMotChu: null});
  }  
        ...
        <Container>
          ...
          <Content>
            ...
            <Form>
              ...
              <Item stackedLabel>
                <Label>Khoản cách trung bình giữa 2 lần bấm khi muốn nhiếp tâm hơn</Label>
                <Input keyboardType="numeric" maxLength={2} placeholderTextColor="gray" placeholder="số giây/ 2 lần bấm" value={this.state.user.tocDoNiemPhat} onChangeText={this.onTGNiemMotChuChange.bind(this)}/>
              </Item>
              <ErrorMsg style={[this.state.errorTGNiemMotChu ? {} : styles.displayNone, s.errorMsg]}>
                  {this.state.errorTGNiemMotChu}
              </ErrorMsg>              
              <Item>
