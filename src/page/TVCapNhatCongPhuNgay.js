...
class TVCapNhatCongPhuNgay extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount() {
    ...
    this.week = this.props.navigation.getParam('week', '');
  ...
  render() {
    return(
      ...
      <View style={[s.header.container]}>
        ...
        <Text style={styles.headerText}>Chỉnh Sửa Công Phu</Text>
      ...
      ?  
      (
        <View style={[s.thoiGianRanhPopupStyle.container, this.state.orientation == "LANDSCAPE" ? this.thoiGianRanhPopupOriginStyle.landscape.container : this.thoiGianRanhPopupOriginStyle.container]}>
...
export default TVCapNhatCongPhuNgay;