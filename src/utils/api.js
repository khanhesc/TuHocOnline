...
export default {
  ...
  async GetVideoLive() {
    return this.fetch('GET', '/youtube/GetVideoLive', null);
  },

  async GetLiveVideoIdFromCache() {
    return this.fetch('GET', '/youtube/GetLiveVideoIdFromCache', null);
  },  
  ...
  async GetPlayListGiangSu(userID,nextPageToken) {
    if(userID != null)
    return this.fetch('GET', '/youtube/GetPlayListType?Type=PhapSuHuongDan&userID='+userID+'&nextPageToken='+nextPageToken, null);
    else 
    return this.fetch('GET', '/youtube/GetPlayListType?Type=PhapSuHuongDan'+'&nextPageToken='+nextPageToken, null);
  },

  async GetPlayListBaiGiang() {
    return this.fetch('GET', '/youtube/GetPlayListType?Type=NenTangGiaoLy', null);
  },  

  async GetVideoChannel(userID) {
    return this.fetch('GET', '/youtube/GetVideoChannel?userID='+userID, null);
  },   
